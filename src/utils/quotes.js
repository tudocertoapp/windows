...
export const VERSICULOS = [
  ...
  'Deuteronômio 31:6 - Sejam fortes e corajosos; o Senhor vai adiante de vocês.',
...
const FINANCE_PROMPTS = {
  madrugada: [
    ...
    'Se quiser, começamos por uma despesa ou receita.',
  ],
  manha: [
    'Bom ritmo de manhã. Bora organizar suas finanças?',
    'Vamos começar o dia registrando receitas e despesas?',
    'Que tal planejar os gastos de hoje em poucos toques?',
    'Bora deixar suas contas organizadas logo cedo?',
    'Comece leve: registre uma movimentação agora.',
  ],
  tarde: [
    'Boa tarde! Bora atualizar suas finanças?',
    'Quer revisar os gastos da manhã e seguir tranquilo?',
    'Vamos cadastrar uma despesa rapidinho?',
    'Bora conferir o saldo e manter tudo no controle?',
    'Que tal registrar as movimentações da tarde?',
  ],
  noite: [
    'Boa noite! Vamos fechar o dia com as contas em ordem?',
    'Bora registrar o que rolou hoje nas finanças?',
    'Quer atualizar os gastos antes de encerrar o dia?',
    'Vamos deixar tudo organizado para amanhã?',
